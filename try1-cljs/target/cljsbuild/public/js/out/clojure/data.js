...
return cljs.core.reduce.call(null,(function (result,p__49751){
...
var vec__49755 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__49755,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__49755,(1),null);
var ab = cljs.core.nth.call(null,vec__49755,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_49761 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_49761.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_49762 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_49762.call(null,a,b);
}
});
...
return (function (){var G__49766 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49766__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1615710651403
