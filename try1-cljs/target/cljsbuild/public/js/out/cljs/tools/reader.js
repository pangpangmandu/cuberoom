...
var G__50745 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__50745;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__50746 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__50746,ch);
...
if(("\\" === ch__$1)){
var ch_50747__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_50747__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_50747__$2);
} else {
}

var G__50748 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__50748;
continue;
}
}
...
var vec__50756 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__50756,(0),null);
var start_column = cljs.core.nth.call(null,vec__50756,(1),null);
...
var G__50759 = cljs.core.conj_BANG_.call(null,a,form);
a = G__50759;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__50760 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__50761 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__50761);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__50760);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__50762 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__50762,(0),null);
var start_column = cljs.core.nth.call(null,vec__50762,(1),null);
...
var vec__50765 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__50765,(0),null);
var end_column = cljs.core.nth.call(null,vec__50765,(1),null);
...
var vec__50768 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__50768,(0),null);
var start_column = cljs.core.nth.call(null,vec__50768,(1),null);
...
var vec__50771 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__50771,(0),null);
var end_column = cljs.core.nth.call(null,vec__50771,(1),null);
...
var vec__50774 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__50774,(0),null);
var start_column = cljs.core.nth.call(null,vec__50774,(1),null);
...
var vec__50777 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__50777,(0),null);
var end_column = cljs.core.nth.call(null,vec__50777,(1),null);
...
var sb = (function (){var G__50780 = (new goog.string.StringBuffer());
G__50780.append(initch);
...
var G__50782 = (function (){var G__50781 = sb;
G__50781.append(ch);

return G__50781;
})();
var G__50783 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__50782;
ch = G__50783;
continue;
}
...
switch (G__50786) {
case "\\":
var G__50790 = (function (){var G__50787 = sb;
G__50787.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__50787;
})();
var G__50791 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__50790;
ch = G__50791;
continue;
...
break;
default:
var G__50792 = (function (){var G__50788 = sb;
G__50788.append(ch);

return G__50788;
})();
var G__50793 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__50792;
ch = G__50793;
continue;
...
var vec__50794 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__50794,(0),null);
var end_column = cljs.core.nth.call(null,vec__50794,(1),null);
...
var vec__50797 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__50797,(0),null);
var column = cljs.core.nth.call(null,vec__50797,(1),null);
...
var vec__50802 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__50802,(0),null);
var column = cljs.core.nth.call(null,vec__50802,(1),null);
...
var vec__50807 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__50807,(0),null);
var column = cljs.core.nth.call(null,vec__50807,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__50812 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__50812,(0),null);
var start_column = cljs.core.nth.call(null,vec__50812,(1),null);
...
var vec__50815 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__50815,(0),null);
var end_column = cljs.core.nth.call(null,vec__50815,(1),null);
...
var G__50818 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__50818,true,null,opts,pending_forms);
...
var G__50819 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__50819)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__50819)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__50819)){
...
var _STAR_suppress_read_STAR__orig_val__50820 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__50821 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__50821);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__50820);
}});
...
var G__50822 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__50822,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__50822,rdr,first_line);
...
var G__50826 = matched;
var G__50827 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__50826;
finished = G__50827;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__50828 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__50829 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__50829);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__50828);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__50830 = cljs.tools.reader.arg_env;
var arg_env_temp_val__50831 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__50831);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__50832 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__50832,"(");
...
var G__50833 = (i + (1));
var G__50834 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__50830);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__50835 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__50835);
...
var G__50838 = cljs.core.next.call(null,s);
var G__50839 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__50838;
key_vals = G__50839;
continue;
} else {
...
var gensym_env_orig_val__50844 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__50845 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__50845);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__50844);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__50846 = token;
var G__50846__$1 = (((G__50846 == null))?null:cljs.core.subs.call(null,G__50846,(1)));
var G__50846__$2 = (((G__50846__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__50846__$1));
var G__50846__$3 = (((G__50846__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__50846__$2));
var G__50846__$4 = (((G__50846__$3 == null))?null:cljs.core.symbol.call(null,G__50846__$3));
if((G__50846__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__50846__$4);
}
})():(function (){var G__50847 = token;
var G__50847__$1 = (((G__50847 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__50847));
if((G__50847__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__50847__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__50858,reader){
...
var opts = map__50859__$1;
var eof = cljs.core.get.call(null,map__50859__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1615710652446
