...
var G__50874 = (function (){var G__50872 = sb;
G__50872.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__50872;
})();
var G__50875 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__50874;
ch = G__50875;
continue;
}
...
var temp__5733__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__50876 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__50876,ch);
...
var vec__50884 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__50884,(0),null);
var start_column = cljs.core.nth.call(null,vec__50884,(1),null);
...
var G__50888 = (((!((mret === rdr))))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__50888;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__50887 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__50887,ch);

return G__50887;
})(),true,null,opts);
var G__50889 = (((!((o === rdr))))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__50889;
continue;
}
}
...
var vec__50890 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__50890,(0),null);
var start_column = cljs.core.nth.call(null,vec__50890,(1),null);
...
var sb = (function (){var G__50893 = (new goog.string.StringBuffer());
G__50893.append(initch);
...
var G__50895 = (function (){var G__50894 = sb;
G__50894.append(ch);

return G__50894;
})();
var G__50896 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__50895;
ch = G__50896;
continue;
}
...
while(true){
var G__50899 = ch;
if(cljs.core._EQ_.call(null,null,G__50899)){
...
if(cljs.core._EQ_.call(null,"\\",G__50899)){
var G__50902 = (function (){var G__50900 = sb;
G__50900.append(cljs.tools.reader.edn.escape_char.call(null,sb,rdr));

return G__50900;
})();
var G__50903 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__50902;
ch = G__50903;
continue;
} else {
...
var G__50904 = (function (){var G__50901 = sb;
G__50901.append(ch);

return G__50901;
})();
var G__50905 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__50904;
ch = G__50905;
continue;
...
var G__50909 = rdr;
cljs.tools.reader.edn.read.call(null,G__50909,true,null,true);
...
var temp__5733__auto__ = (function (){var G__50910 = token;
var G__50910__$1 = (((G__50910 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__50910));
if((G__50910__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__50910__$1);
}
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
var G__50911 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__50911)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__50911)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__50911)){
...
(cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__50918,reader){
var map__50919 = p__50918;
var map__50919__$1 = (((((!((map__50919 == null))))?(((((map__50919.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50919.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50919):map__50919);
var opts = map__50919__$1;
var eof = cljs.core.get.call(null,map__50919__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
}catch (e50921){if((e50921 instanceof Error)){
var e = e50921;
...
//# sourceMappingURL=edn.js.map?rel=1615710652550
