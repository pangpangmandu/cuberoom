...
var G__46436 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__46436,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__46436;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq46438){
var G__46439 = cljs.core.first.call(null,seq46438);
var seq46438__$1 = cljs.core.next.call(null,seq46438);
var G__46440 = cljs.core.first.call(null,seq46438__$1);
var seq46438__$2 = cljs.core.next.call(null,seq46438__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46439,G__46440,seq46438__$2);
}));
...
var file = cljs.core.get.call(null,map__46445__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__46445__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__46445__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__46444_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__46444_SHARP_));
...
var temp__5735__auto___46447 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___46447)){
var message_46448 = temp__5735__auto___46447;
cljs.core.println.call(null,message_46448);
} else {
}
...
var temp__5735__auto___46449 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___46449)){
var message_46450 = temp__5735__auto___46449;
cljs.core.println.call(null,message_46450);
} else {
}
...
var output_dir__$1 = (function (){var G__46451 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__46451,"/"].join('');
} else {
return G__46451;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__46453 = exception.stack;
var G__46453__$1 = (((G__46453 == null))?null:clojure.string.split_lines.call(null,G__46453));
var G__46453__$2 = (((G__46453__$1 == null))?null:cljs.core.get.call(null,G__46453__$1,depth));
if((G__46453__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__46453__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__46454 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__46454,(0),null);
var column = cljs.core.nth.call(null,vec__46454,(1),null);
var vec__46457 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__46457,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__46457,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__46457,(2),null);
...
var m__$1 = (function (){var G__46460 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__46460__$1 = (((G__46460 instanceof cljs.core.Keyword))?G__46460.fqn:null);
switch (G__46460__$1) {
case "fail":
...
var G__46464 = (function (){var G__46463 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__46463);
} else {
return G__46463;
}
})();
...
return cljs.core.vary_meta.call(null,G__46465,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__46467 = e;
var G__46467__$1 = (((G__46467 instanceof cljs.core.Keyword))?G__46467.fqn:null);
switch (G__46467__$1) {
...
var vec__46469 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__46469,(0),null);
var types = vec__46469;
...
return cljs.core.map.call(null,(function (p__46472){
var vec__46473 = p__46472;
var ns = cljs.core.nth.call(null,vec__46473,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__46473,(1),null);
return (function (){
...
var G__46476 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__46476__$1 = (((G__46476 instanceof cljs.core.Keyword))?G__46476.fqn:null);
switch (G__46476__$1) {
case "async":
...
var seq__46477 = cljs.core.seq.call(null,vars__$1);
var chunk__46478 = null;
var count__46479 = (0);
var i__46480 = (0);
while(true){
if((i__46480 < count__46479)){
var v = cljs.core._nth.call(null,chunk__46478,i__46480);
var temp__5735__auto___46482 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___46482)){
var t_46483 = temp__5735__auto___46482;
each_fixture_fn.call(null,((function (seq__46477,chunk__46478,count__46479,i__46480,t_46483,temp__5735__auto___46482,v,each_fixture_fn,G__46476,G__46476__$1,env,once_fixtures,each_fixtures,vec__46473,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_46483)));
});})(seq__46477,chunk__46478,count__46479,i__46480,t_46483,temp__5735__auto___46482,v,each_fixture_fn,G__46476,G__46476__$1,env,once_fixtures,each_fixtures,vec__46473,ns,vars__$1))
);
} else {
}


var G__46484 = seq__46477;
var G__46485 = chunk__46478;
var G__46486 = count__46479;
var G__46487 = (i__46480 + (1));
seq__46477 = G__46484;
chunk__46478 = G__46485;
count__46479 = G__46486;
i__46480 = G__46487;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__46477);
if(temp__5735__auto__){
var seq__46477__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__46477__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__46477__$1);
var G__46488 = cljs.core.chunk_rest.call(null,seq__46477__$1);
var G__46489 = c__4556__auto__;
var G__46490 = cljs.core.count.call(null,c__4556__auto__);
var G__46491 = (0);
seq__46477 = G__46488;
chunk__46478 = G__46489;
count__46479 = G__46490;
i__46480 = G__46491;
continue;
} else {
var v = cljs.core.first.call(null,seq__46477__$1);
var temp__5735__auto___46492__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___46492__$1)){
var t_46493 = temp__5735__auto___46492__$1;
each_fixture_fn.call(null,((function (seq__46477,chunk__46478,count__46479,i__46480,t_46493,temp__5735__auto___46492__$1,v,seq__46477__$1,temp__5735__auto__,each_fixture_fn,G__46476,G__46476__$1,env,once_fixtures,each_fixtures,vec__46473,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_46493)));
});})(seq__46477,chunk__46478,count__46479,i__46480,t_46493,temp__5735__auto___46492__$1,v,seq__46477__$1,temp__5735__auto__,each_fixture_fn,G__46476,G__46476__$1,env,once_fixtures,each_fixtures,vec__46473,ns,vars__$1))
);
} else {
}


var G__46494 = cljs.core.next.call(null,seq__46477__$1);
var G__46495 = null;
var G__46496 = (0);
var G__46497 = (0);
seq__46477 = G__46494;
chunk__46478 = G__46495;
count__46479 = G__46496;
i__46480 = G__46497;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46476__$1)].join('')));
...
//# sourceMappingURL=test.js.map?rel=1615710649078
