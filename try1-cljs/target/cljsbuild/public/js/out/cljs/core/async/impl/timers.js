...
var i_53592 = (0);
while(true){
if((i_53592 < arr.length)){
(arr[i_53592] = null);

var G__53593 = (i_53592 + (1));
i_53592 = G__53593;
continue;
} else {
}
...
var i_53602 = (self__.level + (1));
while(true){
if((i_53602 <= (new_level + (1)))){
(update[i_53602] = self__.header);
...
var i_53604 = (0);
while(true){
if((i_53604 <= self__.level)){
var links_53605 = (update[i_53604]).forward;
if((x__$1 === (((i_53604 < links_53605.length))?(links_53605[i_53604]):null))){
(links_53605[i_53604] = (x__$1.forward[i_53604]));

var G__53606 = (i_53604 + (1));
i_53604 = G__53606;
continue;
} else {
var G__53607 = (i_53604 + (1));
i_53604 = G__53607;
continue;
}
} else {
...
if((!((nx == null)))){
var G__53609 = nx;
var G__53610 = (level__$1 - (1));
x = G__53609;
level__$1 = G__53610;
continue;
} else {
var G__53611 = x;
var G__53612 = (level__$1 - (1));
x = G__53611;
level__$1 = G__53612;
continue;
}
...
var G__53614 = nx;
var G__53615 = (level__$1 - (1));
x = G__53614;
level__$1 = G__53615;
continue;
} else {
var G__53616 = x;
var G__53617 = (level__$1 - (1));
x = G__53616;
level__$1 = G__53617;
continue;
}
...
//# sourceMappingURL=timers.js.map?rel=1615710654561
