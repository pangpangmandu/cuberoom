...
var G__47437 = cljs.core.first.call(null,element_str);
switch (G__47437) {
case "?":
arr.push((1));
...
var G__47439 = cljs.core.next.call(null,items);
items = G__47439;
continue;
} else {
return null;
...
var G__47440 = cljs.core.next.call(null,items);
items = G__47440;
continue;
} else {
return null;
...
var G__47442 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__47442;
continue;
} else {
return true;
...
switch (G__47445) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,(function (p1__47443_SHARP_){
return cljs.core.not_EQ_.call(null,p1__47443_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,(function (p1__47444_SHARP_){
return cljs.core.not_EQ_.call(null,p1__47444_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47445)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1615710649579
