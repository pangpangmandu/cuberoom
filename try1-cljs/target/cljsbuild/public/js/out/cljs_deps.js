...
goog.addDependency("../mount/tools/logger.js", ['mount.tools.logger'], ['goog.debug.Console', 'cljs.core', 'goog.log']);
goog.addDependency("../mount/tools/macro.js", ['mount.tools.macro'], ['cljs.core']);
goog.addDependency("../mount/core.js", ['mount.core'], ['mount.tools.logger', 'cljs.core', 'clojure.set', 'mount.tools.macro']);
goog.addDependency("../cuberoom/db.js", ['cuberoom.db'], ['cljs.core', 'cljs.pprint', 'clojure.string']);
goog.addDependency("../cljs/test.js", ['cljs.test'], ['cljs.core', 'cljs.pprint', 'clojure.string']);
goog.addDependency("../cuberoom/resource.js", ['cuberoom.resource'], ['cuberoom.db', 'cljs.core', 'cljs.test']);
...
goog.addDependency("../cuberoom/js.js", ['cuberoom.js'], ['cljs.core', 'oops.core']);
goog.addDependency("../cuberoom/db/log.js", ['cuberoom.db.log'], ['cljs.core', 'cuberoom.js']);
goog.addDependency("../cuberoom/macros.js", ['cuberoom.macros'], ['cljs.core', 'cljs.test', 'oops.core', 'clojure.string']);
goog.addDependency("../cuberoom/logic/player_animator.js", ['cuberoom.logic.player_animator'], ['cljs.core']);
goog.addDependency("../cuberoom/play_scene.js", ['cuberoom.play_scene'], ['cuberoom.db', 'cljs.core', 'cuberoom.js']);
goog.addDependency("../cuberoom/scene/player.js", ['cuberoom.scene.player'], ['cuberoom.resource', 'cljs.core', 'cuberoom.logic.player_animator', 'cuberoom.play_scene']);
goog.addDependency("../cuberoom/util/timing.js", ['cuberoom.util.timing'], ['cljs.core']);
goog.addDependency("../cuberoom/phaser.js", ['cuberoom.phaser'], ['cljs.core', 'cuberoom.util.timing', 'cuberoom.js']);
goog.addDependency("../cuberoom/logic/camera_follow_player.js", ['cuberoom.logic.camera_follow_player'], ['cljs.core', 'cuberoom.macros', 'cljs.test', 'cuberoom.scene.player', 'oops.core', 'cuberoom.phaser']);
goog.addDependency("../cuberoom/input.js", ['cuberoom.input'], ['cljs.core', 'cljs.test']);
goog.addDependency("../cuberoom/logic/player_move.js", ['cuberoom.logic.player_move'], ['cljs.core', 'cuberoom.scene.player', 'cuberoom.logic.player_animator']);
goog.addDependency("../cuberoom/input/log.js", ['cuberoom.input.log'], ['cljs.core', 'cuberoom.js']);
goog.addDependency("../cuberoom/scene/background.js", ['cuberoom.scene.background'], ['cuberoom.resource', 'cljs.core', 'cuberoom.play_scene']);
goog.addDependency("../cuberoom/scene.js", ['cuberoom.scene'], ['cuberoom.resource', 'cuberoom.db', 'cuberoom.db.log', 'cuberoom.logic.camera_follow_player', 'cljs.core', 'cuberoom.input', 'cuberoom.logic.player_move', 'cuberoom.input.log', 'cuberoom.scene.player', 'cuberoom.scene.background', 'cuberoom.phaser', 'cuberoom.play_scene', 'cuberoom.js']);
...
goog.addDependency("../cuberoom/network.js", ['cuberoom.network'], ['cljs.core', 'cognitect.transit']);
goog.addDependency("../cuberoom/core.js", ['cuberoom.core'], ['mount.core', 'cljs.core', 'cuberoom.scene', 'cuberoom.network', 'cuberoom.js']);
...
goog.addDependency("../cuberoom/app.js", ['cuberoom.app'], ['expound.alpha', 'cljs.core', 'cuberoom.core', 'devtools.core', 'cljs.spec.alpha']);
...
goog.addDependency("../cuberoom/phaser/example/core.js", ['cuberoom.phaser.example.core'], ['cljs.core', 'cuberoom.js']);
goog.addDependency("../struct/core.js", ['struct.core'], ['cljs.core', 'cuerdas.core']);
goog.addDependency("../cuberoom/validation.js", ['cuberoom.validation'], ['struct.core', 'cljs.core']);
