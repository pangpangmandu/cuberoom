...
var o49519 = temp__5733__auto__;
var temp__5733__auto____$1 = (o49519["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o49520 = temp__5733__auto____$1;
return (o49520["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__48877__auto__ = f;
return (o__48877__auto__["toString"]).call(o__48877__auto__);
} else {
return "";
}
}catch (e49521){var _ = e49521;
return "";
}});
...
try{var o__48877__auto___49523 = t;
(o__48877__auto___49523["cljs$lang$ctorPrWriter"]).call(o__48877__auto___49523,t,writer);
}catch (e49522){var __49524 = e49522;
}
...
var char_code = (function (){var o__48877__auto__ = (new String(char$));
return (o__48877__auto__["charCodeAt"]).call(o__48877__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__48877__auto__ = String;
return (o__48877__auto__["fromCharCode"]).call(o__48877__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__49525 = num_code;
switch (G__49525) {
case (1):
return (185);
...
var o__48877__auto__ = String;
return (o__48877__auto__["fromCharCode"]).call(o__48877__auto__,superscript_code);
});
/**
...
}catch (e49527){var _e__48884__auto__ = e49527;
return false;
}})())){
...
var vec__49528 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__49528,(0),null);
...
var len__4736__auto___49537 = arguments.length;
var i__4737__auto___49538 = (0);
while(true){
if((i__4737__auto___49538 < len__4736__auto___49537)){
args__4742__auto__.push((arguments[i__4737__auto___49538]));

var G__49539 = (i__4737__auto___49538 + (1));
i__4737__auto___49538 = G__49539;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__49533){
var vec__49534 = p__49533;
var ns_detector = cljs.core.nth.call(null,vec__49534,(0),null);
...
var G__49540 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__49541 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__49540;
remaining_tokens = G__49541;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq49531){
var G__49532 = cljs.core.first.call(null,seq49531);
var seq49531__$1 = cljs.core.next.call(null,seq49531);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49532,seq49531__$1);
}));
...
var vec__49545 = cljs.core.split_with.call(null,(function (p1__49544_SHARP_){
return cljs.core.not_EQ_.call(null,p1__49544_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__49545,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__49545,(1),null);
...
var vec__49551 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__49551,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__49551,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__49554 = cljs.core.rest.call(null,remaining_tokens);
var G__49555 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__49554;
name_tokens = G__49555;
continue;
} else {
...
var vec__49558 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__49558,(0),null);
var arity = cljs.core.nth.call(null,vec__49558,(1),null);
var vec__49561 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__49561,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__49561,(1),null);
var vec__49564 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__49564,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__49564,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__49564,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__49564,(3),null);
...
var vec__49570 = result;
var munged_ns = cljs.core.nth.call(null,vec__49570,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__49570,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__49570,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__49570,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__49570,(4),null);
var arity = cljs.core.nth.call(null,vec__49570,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__49574 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__49574,(0),null);
var args = cljs.core.nth.call(null,vec__49574,(1),null);
var vec__49577 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__49577,(0),null);
var name = cljs.core.nth.call(null,vec__49577,(1),null);
...
var G__49580 = (arity + (1));
var G__49581 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__49582){
var vec__49583 = p__49582;
var arity = cljs.core.nth.call(null,vec__49583,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__49583,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__49586_SHARP_){
return cljs.core.get.call(null,arities,p1__49586_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__49587_SHARP_){
return cljs.core.drop.call(null,(2),p1__49587_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___49594 = arguments.length;
var i__4737__auto___49595 = (0);
while(true){
if((i__4737__auto___49595 < len__4736__auto___49594)){
args__4742__auto__.push((arguments[i__4737__auto___49595]));

var G__49596 = (i__4737__auto___49595 + (1));
i__4737__auto___49595 = G__49596;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__49590){
var vec__49591 = p__49590;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__49591,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq49588){
var G__49589 = cljs.core.first.call(null,seq49588);
var seq49588__$1 = cljs.core.next.call(null,seq49588);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49589,seq49588__$1);
}));
...
var G__49597 = arg;
var G__49597__$1 = (((G__49597 instanceof cljs.core.Keyword))?G__49597.fqn:null);
switch (G__49597__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__49599__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__49599__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__49599__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__49599__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__49600 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__49600,(0),null);
var fn_name = cljs.core.nth.call(null,vec__49600,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__49600,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__49600,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__49600,(4),null);
var arity = cljs.core.nth.call(null,vec__49600,(5),null);
...
var o__48877__auto__ = f;
return (o__48877__auto__["getBasis"]).call(o__48877__auto__);
});
/**
...
}catch (e49604){var _e__48884__auto__ = e49604;
...
var G__49605 = (obj[cljs.core.first.call(null,path)]);
var G__49606 = cljs.core.rest.call(null,path);
obj = G__49605;
path = G__49606;
continue;
} else {
...
var _STAR_ = (function (accum,p__49607){
var vec__49608 = p__49607;
var bit = cljs.core.nth.call(null,vec__49608,(0),null);
var protocol = cljs.core.nth.call(null,vec__49608,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__49611){
var vec__49612 = p__49611;
var ns = cljs.core.nth.call(null,vec__49612,(0),null);
var name = cljs.core.nth.call(null,vec__49612,(1),null);
var selector = cljs.core.nth.call(null,vec__49612,(2),null);
...
var post_process = (function (p__49616){
var vec__49617 = p__49616;
var munged_name = cljs.core.nth.call(null,vec__49617,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__49617,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__49615_SHARP_){
return (obj[cljs.core.first.call(null,p1__49615_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1615710651148
