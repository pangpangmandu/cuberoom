...
return (new CustomEvent(event_name,(function (){var obj55602 = ({"detail":data});
return obj55602;
})()));
} else {
...
var f = (function (){var pred__55609 = cljs.core._EQ_;
var expr__55610 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__55609.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__55610))){
return (function (p1__55603_SHARP_){
return console.warn(p1__55603_SHARP_);
});
} else {
if(cljs.core.truth_(pred__55609.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__55610))){
return (function (p1__55604_SHARP_){
return console.debug(p1__55604_SHARP_);
});
} else {
if(cljs.core.truth_(pred__55609.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__55610))){
return (function (p1__55605_SHARP_){
return console.error(p1__55605_SHARP_);
});
} else {
return (function (p1__55606_SHARP_){
return console.log(p1__55606_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__55613){
var map__55614 = p__55613;
var map__55614__$1 = (((((!((map__55614 == null))))?(((((map__55614.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55614.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55614):map__55614);
var opts = map__55614__$1;
var eval_fn = cljs.core.get.call(null,map__55614__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__55616_SHARP_){
return new_def.callback(p1__55616_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__55617){
var vec__55618 = p__55617;
var ky = cljs.core.nth.call(null,vec__55618,(0),null);
var v = cljs.core.nth.call(null,vec__55618,(1),null);
...
}catch (e55623){if((e55623 instanceof Error)){
var e = e55623;
return not_found;
} else {
throw e55623;
...
//# sourceMappingURL=utils.js.map?rel=1615710655271
