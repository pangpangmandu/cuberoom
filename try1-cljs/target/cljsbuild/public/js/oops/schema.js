...
var G__6363 = cljs.core.first.call(null,element_str);
switch (G__6363) {
case "?":
arr.push((1));
...
var G__6365 = cljs.core.next.call(null,items);
items = G__6365;
continue;
} else {
return null;
...
var G__6366 = cljs.core.next.call(null,items);
items = G__6366;
continue;
} else {
return null;
...
var G__6368 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__6368;
continue;
} else {
return true;
...
switch (G__6371) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,(function (p1__6369_SHARP_){
return cljs.core.not_EQ_.call(null,p1__6369_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,(function (p1__6370_SHARP_){
return cljs.core.not_EQ_.call(null,p1__6370_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6371)].join('')));
