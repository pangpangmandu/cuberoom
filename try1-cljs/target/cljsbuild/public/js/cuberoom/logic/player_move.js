...
var distance_unit = (function (){var G__8981 = len;
switch (G__8981) {
case (0):
return (0);
...
var vec__8983 = move_vec;
var x = cljs.core.nth.call(null,vec__8983,(0),null);
var y = cljs.core.nth.call(null,vec__8983,(1),null);
...
var vec__8986 = move_vec;
var x = cljs.core.nth.call(null,vec__8986,(0),null);
var y = cljs.core.nth.call(null,vec__8986,(1),null);
if(cljs.core._EQ_.call(null,(0),x,y)){
return new cljs.core.Keyword(null,"not-moved","not-moved",-491812071);
} else {
...
var vec__8989 = move_vec;
var x = cljs.core.nth.call(null,vec__8989,(0),null);
var y = cljs.core.nth.call(null,vec__8989,(1),null);
if((y > (0))){
...
var expr__8993 = anim_direction;
if(cljs.core.truth_(pred__8992.call(null,new cljs.core.Keyword(null,"up","up",-269712113),expr__8993))){
return new cljs.core.Keyword(null,"player-walk-up","player-walk-up",998538181);
} else {
if(cljs.core.truth_(pred__8992.call(null,new cljs.core.Keyword(null,"down","down",1565245570),expr__8993))){
return new cljs.core.Keyword(null,"player-walk-down","player-walk-down",1556536564);
} else {
if(cljs.core.truth_(pred__8992.call(null,new cljs.core.Keyword(null,"right","right",-452581833),expr__8993))){
return new cljs.core.Keyword(null,"player-walk-right","player-walk-right",-1530347363);
} else {
if(cljs.core.truth_(pred__8992.call(null,new cljs.core.Keyword(null,"left","left",-399115937),expr__8993))){
...
var map__8995 = cuberoom.logic.player_move.update_anim.call(null,db,move_vec);
...
var anim_db = cljs.core.get.call(null,map__8995__$1,new cljs.core.Keyword(null,"db","db",993250759));
var anim_commands = cljs.core.get.call(null,map__8995__$1,new cljs.core.Keyword(null,"commands","commands",161008658));
