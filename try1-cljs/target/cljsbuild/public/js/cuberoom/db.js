...
return cljs.core.swap_BANG_.call(null,cuberoom.db.get_db.call(null),(function (p1__5990_SHARP_){
return cuberoom.db.update_or.call(null,p1__5990_SHARP_,key,update_fn,default$);
}));
}));
...
return cljs.core.swap_BANG_.call(null,cuberoom.db.get_db.call(null),(function (p1__5994_SHARP_){
return cuberoom.db.set_if_empty.call(null,p1__5994_SHARP_,key,value);
}));
}));
