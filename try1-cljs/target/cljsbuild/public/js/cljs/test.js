...
var G__6198 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__6198,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__6198;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq6200){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6201,G__6202,seq6200__$2);
}));
...
var map__6207 = m;
var map__6207__$1 = (((((!((map__6207 == null))))?(((((map__6207.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6207.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6207):map__6207);
var file = cljs.core.get.call(null,map__6207__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__6207__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__6207__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__6206_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__6206_SHARP_));
...
var temp__5735__auto___6209 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___6209)){
var message_6210 = temp__5735__auto___6209;
cljs.core.println.call(null,message_6210);
} else {
}
...
var temp__5735__auto___6211 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___6211)){
var message_6212 = temp__5735__auto___6211;
cljs.core.println.call(null,message_6212);
} else {
}
...
var output_dir = "target/cljsbuild/public/js";
var output_dir__$1 = (function (){var G__6213 = output_dir;
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__6215 = exception.stack;
var G__6215__$1 = (((G__6215 == null))?null:clojure.string.split_lines.call(null,G__6215));
var G__6215__$2 = (((G__6215__$1 == null))?null:cljs.core.get.call(null,G__6215__$1,depth));
if((G__6215__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__6215__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__6216 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__6216,(0),null);
var column = cljs.core.nth.call(null,vec__6216,(1),null);
var vec__6219 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__6219,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__6219,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__6219,(2),null);
...
var m__$1 = (function (){var G__6222 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__6222__$1 = (((G__6222 instanceof cljs.core.Keyword))?G__6222.fqn:null);
switch (G__6222__$1) {
case "fail":
...
var G__6226 = (function (){var G__6225 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__6225);
} else {
return G__6225;
}
})();
...
return cljs.core.vary_meta.call(null,G__6227,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__6231 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__6231,(0),null);
var types = vec__6231;
...
return cljs.core.map.call(null,(function (p__6234){
var vec__6235 = p__6234;
var ns = cljs.core.nth.call(null,vec__6235,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__6235,(1),null);
return (function (){
...
var G__6238 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__6239 = cljs.core.seq.call(null,vars__$1);
var chunk__6240 = null;
var count__6241 = (0);
var i__6242 = (0);
while(true){
if((i__6242 < count__6241)){
var v = cljs.core._nth.call(null,chunk__6240,i__6242);
var temp__5735__auto___6244 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___6244)){
var t_6245 = temp__5735__auto___6244;
each_fixture_fn.call(null,((function (seq__6239,chunk__6240,count__6241,i__6242,t_6245,temp__5735__auto___6244,v,each_fixture_fn,G__6238,G__6238__$1,env,once_fixtures,each_fixtures,vec__6235,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_6245)));
});})(seq__6239,chunk__6240,count__6241,i__6242,t_6245,temp__5735__auto___6244,v,each_fixture_fn,G__6238,G__6238__$1,env,once_fixtures,each_fixtures,vec__6235,ns,vars__$1))
);
} else {
}


var G__6246 = seq__6239;
var G__6247 = chunk__6240;
var G__6248 = count__6241;
...
var temp__5735__auto__ = cljs.core.seq.call(null,seq__6239);
if(temp__5735__auto__){
var seq__6239__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__6239__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__6239__$1);
var G__6250 = cljs.core.chunk_rest.call(null,seq__6239__$1);
var G__6251 = c__4556__auto__;
var G__6252 = cljs.core.count.call(null,c__4556__auto__);
var G__6253 = (0);
seq__6239 = G__6250;
chunk__6240 = G__6251;
count__6241 = G__6252;
...
var v = cljs.core.first.call(null,seq__6239__$1);
var temp__5735__auto___6254__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___6254__$1)){
var t_6255 = temp__5735__auto___6254__$1;
each_fixture_fn.call(null,((function (seq__6239,chunk__6240,count__6241,i__6242,t_6255,temp__5735__auto___6254__$1,v,seq__6239__$1,temp__5735__auto__,each_fixture_fn,G__6238,G__6238__$1,env,once_fixtures,each_fixtures,vec__6235,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_6255)));
});})(seq__6239,chunk__6240,count__6241,i__6242,t_6255,temp__5735__auto___6254__$1,v,seq__6239__$1,temp__5735__auto__,each_fixture_fn,G__6238,G__6238__$1,env,once_fixtures,each_fixtures,vec__6235,ns,vars__$1))
);
} else {
}


var G__6256 = cljs.core.next.call(null,seq__6239__$1);
var G__6257 = null;
var G__6258 = (0);
var G__6259 = (0);
seq__6239 = G__6256;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6238__$1)].join('')));
